                                ...
                                <tbody>
                                    <tr
                                        ...
                                        <td className="px-6 py-4">
                                                ...
                                                <div className="flex">
                                                    <Link to="/admin/artikel/detail"
                                                    className="m-2 mt-5 px-7 py-3 text-green-700 hover:text-white border border-green-700 hover:bg-green-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm  text-center mr-2 mb-2 ">
                                                        Detail
                                                    </Link>
