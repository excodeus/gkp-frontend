                                        ...
                                        <td>
                                            <div className="flex">
                                                <button data-modal-target="edit-modal"
                                                    ...
                                                    className="m-2 mt-5 px-7 py-3 text-sm font-medium text-white inline-flex items-center bg-yellow-500 hover:bg-blue-500 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg text-center "
                                                    type="button">
                            ...
                            <div className="relative w-full max-w-md max-h-full">
                                ...
                                <div className="relative bg-white rounded-lg shadow ">
                                    ...
                                    <div className="px-6 py-6 lg:px-8">
                                        <h3 className="mb-4 text-xl font-medium text-green-700 ">TAMBAH FOTO
                                        </h3>
                                        <div
                        ...
                        <div id="edit-modal" tabIndex="-1" aria-hidden="true"
                            ...
                            <div className="relative w-full max-w-md max-h-full">
                                ...
                                <div className="relative bg-white rounded-lg shadow ">
                                    ...
                                    <div className="px-6 py-6 lg:px-8">
                                        <h3 className="mb-4 text-xl font-medium text-green-700 ">EDIT FOTO
                                        </h3>
                                        <div
                                            className="mb-5 w-full max-w-sm p-4 bg-white border border-white rounded-lg shadow sm:p-6 md:p-8 ">
                                            <form className="space-y-6" action="#">
