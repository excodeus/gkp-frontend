  ...
  return (
    <div class="max-w-screen-xl mx-auto py-16 px-4">
        <div class="bg-white p-8 rounded-lg shadow-md">
            <h1 class="text-3xl font-bold mb-4">Nama Lowongan: Frontend Developer</h1>
            <h2 class="text-xl font-semibold mb-8">Posisi: Jakarta</h2>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                
                {/* <!-- Informasi Kontak --> */}
                <div>
                    <h3 class="text-lg font-semibold mb-2">Informasi Kontak</h3>
                    <p class="text-gray-600 mb-1">Nama Kontak: John Doe</p>
                    <p class="text-gray-600 mb-1">Email: john.doe@example.com</p>
                    <p class="text-gray-600 mb-1">Telepon: 123-456-7890</p>
                </div>
