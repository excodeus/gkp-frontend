...
const Jumbotron = () => {
  return (
    <div className="relative top-0 h-66">
      <Carousel
        showArrows={true}
        showThumbs={false}
        autoPlay={true}
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center px-4 mx-auto max-w-screen-xl text-center py-24 lg:py-56">
        <h1 className="mb-4 font-extrabold tracking-tight leading-none text-white text-6xl pb-4">
          We Value Your Trust
        </h1>
        <p className="mb-8 text-base font-normal text-gray-300 lg:text-2xl sm:px-16 lg:px-48">
        ...
        <div className="flex flex-col space-y-4 sm:flex-row sm:justify-center sm:space-y-0 mt-4">
          <Link to="/produk_kategori"
            className="inline-flex justify-center items-center py-4 px-6 text-lg font-medium text-center text-white rounded-lg bg-button hover:bg-green-700 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900">
            Get started
          ...
          <Link to="/tentang"
            className="inline-flex justify-center hover:text-gray-900 items-center py-4 px-6 sm:ml-4 text-lg font-medium text-center text-white rounded-lg border border-white hover:bg-gray-100 focus:ring-4 focus:ring-gray-400">
            Learn more
          </Link>
        </div>
      </div>
